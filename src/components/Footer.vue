...
.footer-item li a, .about-item-list{
...
/* containers positioning & spacing */
.c-contact, .c-categories, .c-about, .c-social, 
.categories-list, .single-social-link{
    float: left;
}
.footer-item h3, .c-social ul, 
.c-about ul, .c-categories ul, .c-contact ul{
    margin-top: 0;
}
...
/*  footer svg objects sizing  */
.single-social-link div{
    padding: 0 0.5em 0 0.6em;
}


/*  footer hyperlinks colors  */
.categories-list a:link , .categories-list a:visited,
.c-about li a:link, .c-about li a:visited{
    color: #c3b1b1;
}
