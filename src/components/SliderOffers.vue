            ...
            <div class="container">
                ...
                <div class="container-2">
                    <div class="offerbanner">
                        <p id="offer">55%</p>
                        <p id="label">Summer salles</p>
                    </div>
                    <div class="followinvite">
                        <p id="fllw1">Follow us on Facebook</p>
                        <p id="fllw2">Sed ut perspiciatis unde omnis iste natus error sit</p>
                        <div class="linkbutton">
                            <a href="#"> <svg class="facebook-link"><use xlink:href="#facebook"/></svg> Follow</a>
                        </div>    
                    </div>
                </div>
            </div>    
...
<style scoped>
.container{margin:26px 55px}.container-1,.container-2{display:inline-block}.container-1{width:870px;display:inline-block}.container-1 .slide{height:505px;border-radius:8px;background-color:#45413e;font-family:LatoRegular;color:#fff}.container-1 .slide #message{margin:0 60px 0 60px}.container-1 .slide h1,.container-1 .slide p{margin:60px 0;letter-spacing:1.2px;text-shadow:1px 1px 2px #45413e}.view-morebutton a{font-family:LatoRegular;font-size:14px;text-transform:uppercase;letter-spacing:1.1px;padding:9px 34px;line-height:30px;text-decoration:none;color:#fff;width:150px;height:30px;border:2px solid #fff;border-radius:22px;transition-duration:.5s}.view-morebutton a:hover{color:#000;background-color:#fff;border:2px solid #fff}.container-1 .slide1{text-align:left;background:#45413e url(../assets/imgs/slider-background3.png) no-repeat 15% 60%}.container-1 .slide2{text-align:center;background:url(../assets/imgs/slider-background2.png) no-repeat 30% 100%}.container-1 .slide3{text-align:right;background:url(../assets/imgs/slider-background1.png) no-repeat 15% 5%}.container-1 .slide4{text-align:center;background:url(../assets/imgs/slider-background4.png) no-repeat right}.container-1 .slide5{text-align:right;background:url(../assets/imgs/slider-background5.png) no-repeat 100% 97%}.container-1 .slide6{text-align:left;background:url(../assets/imgs/slider-background6.png) no-repeat 65% 20%}.offerbanner{margin:0 0 0 30px;text-align:center;width:270px;height:355px;border-radius:5px;display:block;background:url(../assets/imgs/palm-tree.png) no-repeat,rgba(133,190,29,.85);background-size:190px;background-position-y:190px;background-position-x:-4px}.offerbanner p{font-family:LatoRegular;color:#fff;text-transform:uppercase;float:left}.offerbanner #offer{font-size:100px;font-weight:900;margin:44px 37px}.offerbanner #label{font-size:20px;margin:37px 70px 69px 70px}.followinvite{width:270px;margin:13px 0 0 30px;display:block;text-align:center;float:left}.followinvite p{font-family:LatoRegular;color:#45413e;margin:14px 24px}.followinvite #fllw1{font-size:18px}.followinvite #fllw2{font-size:14px}.followinvite .linkbutton{font-family:LatoRegular;text-transform:uppercase;margin:auto;width:150px;height:40px;border:2px solid #3a5b96;border-radius:22px}.linkbutton a{padding:12px 28px;line-height:40px;text-decoration:none;color:#3a5b96}.linkbutton .facebook-link{height:1.2em;width:1.2em;padding:0;margin:-4px 0;fill:#3a5b96}
</style>

<style >

/* Used by vue-agile pligun carousel */
.agile__dots {
  bottom: 10px;
  left: 50%;
  position: absolute;
