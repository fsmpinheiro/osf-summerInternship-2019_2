        ...
        <li class="competence">
          <div>
            ...
            <div class="container">
              ...
              <p
                id="p2"
              >Our unwavering focus on superior service delivery and building next generation competencies</p>
            </div>
          </div>
        </li>
        ...
        <li class="competence">
          <div>
            ...
            <div class="container">
              ...
              <p
                id="p2"
              >A standardized methodology designed to deliver measurable business results and predictable costs</p>
            </div>
          </div>
        </li>
        ...
        <li class="competence">
          <div>
            ...
            <div class="container">
              ...
              <p
                id="p2"
              >A high skilled, proactive workforce that reliably improves each client's ROI while mitigating their business risk</p>
            </div>
          </div>
        </li>
      </ul>
